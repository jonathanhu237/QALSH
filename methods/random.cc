    ...
    float &p2)         // p2 = p(w / (c * r)) (return)
{
  ...
  for (int i = 0; i < num; ++i) {
    ...
    // ---------------------------------------------------------------------
    if (obj_bucket == q1_bucket)
      bucket_count_1++;
    if (obj_bucket == q2_bucket)
      bucket_count_2++;
  }
  // -------------------------------------------------------------------------
    ...
    float &p2)        // p2 = p(w / (c * r)) (return)
{
  ...
  for (int i = 0; i < num; ++i) {
    ...
    // ---------------------------------------------------------------------
    if (fabs(obj_proj_dist - q1_proj_dist) < w / 2.0f)
      dist_count_1++;
    if (fabs(obj_proj_dist - q2_proj_dist) < w / 2.0f)
      dist_count_2++;
  }
  // -------------------------------------------------------------------------
